...
public class TllFactoryImpl extends EFactoryImpl implements TllFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case TllPackage.SYSTEM: return (EObject)createSystem();
			case TllPackage.AREA: return (EObject)createArea();
			case TllPackage.TURNTABLE: return (EObject)createTurntable();
			case TllPackage.CONVEYOR: return (EObject)createConveyor();
			case TllPackage.MACHINE: return (EObject)createMachine();
			case TllPackage.NAMED_ELEMENT: return (EObject)createNamedElement();
			case TllPackage.ITEM: return (EObject)createItem();
			case TllPackage.ITEM_GENERATOR: return (EObject)createItemGenerator();
			case TllPackage.WAITING_QUEUE: return (EObject)createWaitingQueue();
			case TllPackage.STORAGE_QUEUE: return (EObject)createStorageQueue();
			case TllPackage.SIM_CONFIG: return (EObject)createSimConfig();
			case TllPackage.LOCATION_HISTORY_ENTRY: return (EObject)createLocationHistoryEntry();
			case TllPackage.ITEM_HISTORY_ENTRY: return (EObject)createItemHistoryEntry();
			default:
