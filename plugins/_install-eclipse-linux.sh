...
"$tmpdir/eclipse/eclipse" \
   ...
   -repository http://download.eclipse.org/releases/$version/,https://abelgomez.github.io/eclipse.hbase/updates/,https://som-research.github.io/temporal-emf/updates/\
   -installIU $features
